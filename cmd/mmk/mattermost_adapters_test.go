...
func TestMattermostSnapshotAdaptersPreserveRawIdentityAndRebuildNames(t *testing.T) {
	...
	if raw.Server.LastSyncedAt != 1234 || raw.Channels[0].DisplayName != "Direct display" || raw.Memberships[0].UpdatedAt != 88 || !reflect.DeepEqual(raw.ChannelUsers["dm"], []string{"me", "peer"}) {
