...
var reduceChannels reducerFunc = func(a *App, msg tea.Msg) (tea.Cmd, bool) {
	...
	case MattermostMessagesLoadedMsg:
		...
		if m.Err == nil {
			a.messagepane.ReconcileRecentPage(m.CachedIDs, m.AuthoritativeIDs, m.Messages, m.HasMore)
	...
	case MattermostOlderMessagesLoadedMsg:
		...
		a.messagepane.ReconcileOlderPage(m.AnchorID, m.CachedIDs, m.AuthoritativeIDs, m.Messages, m.HasMore)
		if !m.HasMore {
